...
},
{
    ...
    {
        name: "东莞市",
        districtAndCounty: ["东城街道", "南城街道", "万江街道", "莞城街道", "石碣镇", "石龙镇", "茶山镇", "石排镇", "企石镇", "横沥镇", "桥头镇", "谢岗镇", "东坑镇", "常平镇", "寮步镇", "樟木头镇", "大朗镇", "黄江镇", "清溪镇", "塘厦镇", "凤岗镇", "大岭山镇", "长安镇", "虎门镇", "厚街镇", "沙田镇", "道滘镇", "洪梅镇", "麻涌镇", "望牛墩镇", "中堂镇", "高埗镇", "松山湖", "东莞港", "东莞生态园"]
    },
    {
        name: "珠海市",
    ...
    {
        name: "中山市",
        districtAndCounty: ["石岐街道", "东区街道", "中山港街道", "西区街道", "南区街道", "五桂山街道", "小榄镇", "民众镇", "东凤镇", "东升镇", "古镇镇", "沙溪镇", "坦洲镇", "港口镇", "三角镇", "横栏镇", "南头镇", "阜沙镇", "南朗镇", "三乡镇", "板芙镇", "大涌镇", "神湾镇"]
    },
    {
        name: "江门市",
...
},
{
    ...
    {
        name: "三亚市",
        districtAndCounty: ["海棠区", "吉阳区", "天涯区", "崖州区",]
    },
    {
        name: "省直辖行政单位",
...
},
{
    ...
    city: [{
        name: "台北",
        districtAndCounty: ["中正区", "大同区", "中山区", "松山区", "大安区", "万华区", "信义区", "士林区", "北投区", "内湖区", "南港区", "文山区", "其它区"]
    },
    {
        name: "高雄",
        districtAndCounty: ["新兴区", "前金区", "芩雅区", "盐埕区", "鼓山区", "旗津区", "前镇区", "三民区", "左营区", "楠梓区", "小港区", "其它区"]
    },
    {
        name: "台中",
        districtAndCounty: ["中区", "东区", "南区", "西区", "北区", "北屯区", "西屯区", "南屯区", "其它区"]
    },
    {
        name: "基隆",
        districtAndCounty: ["仁爱区", "信义区", "中正区", "中山区", "安乐区", "暖暖区", "七堵区", "其它区"]
    },
    {
        name: "嘉义",
        districtAndCounty: ["东区", "西区", "其它区"]
    },
    {
        name: "台南",
        districtAndCounty: ["中西区", "东区", "南区", "北区", "安平区", "安南区", "其它区"]
    },
    {
        name: "新竹",
        districtAndCounty: ["东区", "北区", "香山区", "其它区"]
    },
    {
        name: "行政区",
        districtAndCounty: ["金门县", "南投县", "新北市", "宜兰县", "新竹县", "桃园县", "苗栗县", "彰化县", "嘉义县", "云林县", "屏东县", "台东县", "花莲县", "澎湖县"]
    }
    ]
}
];